**L'objectif de ce projet est de récupérer le profil d'un utilisateur généré aléatoirement via l'api randomuser (https://randomuser.me/) et l'intégrer sur une page web.**
